...
HR Admin is a free and open-sourced Bootstrap themed Angular 9 starter project.
...
HR Admin comes with a base implementation of navigation and layouts.
...
```bash
git clone git@github.com:startbootstrap/hr-admin.git
cd hr-admin
npm install
npm start
```
...
HR Admin come with a production ready Dockerfile and build scripts.
